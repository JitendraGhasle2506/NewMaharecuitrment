...
public class V52__attendance_holiday_soft_delete_support extends BaseJavaMigration {

    private static final String TABLE_NAME = "holiday_master";
    private static final String COLUMN_NAME = "is_active";
    private static final String INDEX_NAME = "idx_holiday_master_active";
    ...
    public void migrate(Context context) throws Exception {
        ...
        if (!indexExists(connection, TABLE_NAME, INDEX_NAME)) {
            jdbcTemplate.execute("""
                    create index idx_holiday_master_active
                    on holiday_master (is_active)
                    """);
        }
    }
