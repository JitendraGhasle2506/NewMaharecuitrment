...
public class R__md_workforce_report_navigation extends BaseJavaMigration {

    private static final String ROLE_MD = "ROLE_MD";
    private static final String REPORT_NAME = "Wing Cell Employee Report";
    private static final String REPORT_URL = "/md/reports/wing-cell-employees";
    private static final String REPORT_ICON = "fa-solid fa-users-viewfinder";
    ...
    public void migrate(Context context) {
        ...
        Long menuId = upsertReportMenu(jdbcTemplate);
        if (menuId != null) {
    ...
    private Long upsertReportMenu(JdbcTemplate jdbcTemplate) {
