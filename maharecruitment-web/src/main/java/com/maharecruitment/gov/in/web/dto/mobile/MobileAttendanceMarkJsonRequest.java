...
public record MobileAttendanceMarkJsonRequest(
        @NotNull(message = "Attendance flag is required.")
        @JsonAlias({ "flag", "action", "attendanceAction", "type" })
        MobileAttendanceAction attendanceFlag,
