...
@Entity
@Table(
        name = "department_project_application_activity",
        indexes = {
                @Index(name = "idx_dep_project_activity_app_id", columnList = "department_project_application_id"),
                @Index(name = "idx_dep_project_activity_time", columnList = "action_timestamp")
        })
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class DepartmentProjectApplicationActivityEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "department_project_application_activity_id")
    private Long departmentProjectApplicationActivityId;
