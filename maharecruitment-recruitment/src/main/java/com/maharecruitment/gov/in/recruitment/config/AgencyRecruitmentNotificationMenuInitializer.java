...
@Component
public class AgencyRecruitmentNotificationMenuInitializer {

    private static final Logger log = LoggerFactory.getLogger(AgencyRecruitmentNotificationMenuInitializer.class);

    private final MstMenuRepository mstMenuRepository;
    private final RoleRepository roleRepository;

    public AgencyRecruitmentNotificationMenuInitializer(
    ...
    private void upsertDirectMenu(
        ...
        log.info("Agency recruitment notification menu bootstrapped. menuId={}, menuName={}, url={}",
                saved.getMenuId(),
    ...
    private Role createRoleIfMissing(String roleName) {
        ...
        log.info("Role created for Agency recruitment notification menu bootstrap: {}", saved.getName());
        return saved;
    }
}
