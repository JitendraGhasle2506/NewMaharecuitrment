...
@Entity
@Table(
        name = "recruitment_external_interview_feedback",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uk_external_interview_feedback_detail_user",
                        columnNames = {
        ...
        indexes = {
                @Index(
                        name = "idx_external_interview_feedback_detail",
                        columnList = "recruitment_interview_detail_id"),
                @Index(
                        name = "idx_external_interview_feedback_user",
...
@NoArgsConstructor
@AllArgsConstructor
public class RecruitmentExternalInterviewFeedbackEntity extends RecruitmentAuditable {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "recruitment_external_interview_feedback_id")
    private Long recruitmentExternalInterviewFeedbackId;
