...
@Component
public class AgencyOnboardingMenuInitializer {

    private static final Logger log = LoggerFactory.getLogger(AgencyOnboardingMenuInitializer.class);

    private final MstMenuRepository mstMenuRepository;
    private final RoleRepository roleRepository;

    public AgencyOnboardingMenuInitializer(
    ...
    private void upsertDirectMenu(
        ...
        log.info("Agency onboarding menu bootstrapped. menuId={}, menuName={}, url={}",
                saved.getMenuId(),
    ...
    private Role createRoleIfMissing(String roleName) {
        ...
        log.info("Role created for Agency onboarding menu bootstrap: {}", saved.getName());
        return saved;
    }
}
